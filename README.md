...
It defines two additional table roles: `table_caption` and `table_section`,
which is the role shared by table head, bodies and foot.
 ...
 * **`tableNodes`**`(options: Object) → Object`\
   ...
   `table`, `table_row`, `table_caption`, `table_section`
   and `table_cell` nodes types as used by this module.
